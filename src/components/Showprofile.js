        ...
        <div className="container my-5" >
            <div className="row mt-auto">
                <div className="col-lg-8 col-sm-12 text-center mx-auto">
                    <h1 className="font-medium leading-tight text-3xl mt-0 mb-2 text-black">GitHub User Profile With React JS</h1>
                </div>
            </div>
            <div className="row">
                ...
                <div className="col-md-6 mx-auto text-center">
                    <div className="row mb-5 justify-content-center">
                        ...
                        <a href="/"> <button type='button' className="bg-purple-700 hover:bg-purple-900 float-right text-white font-semibold hover:text-black py-2 px-6 border border-black hover:border-black rounded">Back</button></a>
